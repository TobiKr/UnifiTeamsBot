...
namespace azuregeek.UnifiTeamsBotApp
{
    ...
    public class GraphClient
    {
        ...
        */
        ...
        // gets group memberships of the user
        public async Task<IUserMemberOfCollectionWithReferencesPage> GetGroupsAsync()
        {
            var graphClient = GetAuthenticatedClient();
            var groups = await graphClient.Me.MemberOf.Request().GetAsync() as IUserMemberOfCollectionWithReferencesPage;
            return groups;
        }
